...
import 'package:relation/helpers/my_widgets/my.dart';
import 'package:relation/helpers/my_widgets/my_breadcrumb_item.dart';
...
class AppTheme {
  ...
  static final ThemeData darkTheme = ThemeData.dark().copyWith(
    ...
    /// AppBar Theme
    appBarTheme: AppBarTheme(
      backgroundColor: Color(0xff221A14).withOpacity(0.5),
    ),
  ...
  static void initMyStyle() {
    ...
    My.setConstant(MyConstantData(
      ...
      defaultBreadCrumbItem:
          MyBreadcrumbItem(name: 'relation', route: '/dashboard'),
    ));
    bool isMobile = true;
    try {
